 ...
 * XXX
 * 
 * @author Robert C. Duvall * @modified by Jack Matteucci * @modified by
 *         Francesco Agosti
 */
public class Factory {
	...
	/**
	 * Loads a File into the model and creates all of the objects as specified
	 * in the file.
	 */
	...
	/**
	 * Where all forces are added to the model. If they were made to have custom
	 * values in the factory, those versions are added, otherwise, the default
	 * versions are added.
	 */
